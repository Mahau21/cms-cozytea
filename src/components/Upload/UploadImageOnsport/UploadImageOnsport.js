...
const config16_9 = JSON.stringify([{ width: 720, height: 405 }])
...
const UploadImage = React.forwardRef(({ onChange, value, aspect, is11 }, ref) => {
    ...
    <div className="flex items-center">
      <ImgCrop rotate aspect={aspect} beforeCrop={beforeUpload} quality={1} fillColor="transparent">
        <Upload
          ...
          }/api/v1/file/upload/imagecustom?configThumString=${is11 ? config1_1 : config16_9}`}
